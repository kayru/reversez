...
namespace Rush
{
	...
	class RenderContextGLES2 : public RenderContextBase
	{
	public:

		RenderContextGLES2();

		void init(RenderDeviceStats* stats, RenderResourcesGLES2* resources);
	...
	private:
		...
		RenderResourcesGLES2* m_resources;
	...
	class RenderContext : public RenderContextGLES2 {};

	class RenderDeviceGLES2 : public ReferenceCount
	{
        friend class RenderContextGLES2;

	public:

		RenderDeviceGLES2(Rush::Window* window, const RenderDeviceConfig& cfg);
		~RenderDeviceGLES2();
	...
	private:
		...
		RenderDeviceGLES2Private*		m_private;
		RenderResourcesGLES2*			m_resources;
        RenderDeviceStats               m_stats;
	...
	typedef RenderDeviceGLES2 NativeRenderDevice;
